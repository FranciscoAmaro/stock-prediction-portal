...
class StockPredictionAPIView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            plt.title(f"100 Days Moving Avarage of {ticker}")
            plt.xlabel('Days')
            plt.ylabel('Price')
            plt.legend()
            # Save the plot to a file
            ...
            plt.title(f"200 Days Moving Avarage of {ticker}")
            plt.xlabel('Days')
            plt.ylabel('Price')
            plt.legend()
            # Save the plot to a file
            ...
            for i in range(100, input_data.shape[0]):
                ...
                y_text.append(input_data[i,0])
            x_test = np.array(x_text)
            ...
            plt.plot(y_predicted, 'r', label='Predicted0 Price')
